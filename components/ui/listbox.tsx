    ...
    <HeadlessListbox {...props} multiple={false}>
      <HeadlessListboxButton
        ...
        className={clsx([
          ...
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-inset after:ring-transparent sm:after:data-[focus]:ring-2 sm:after:data-[focus]:ring-lime-500',
        ...
        return (
          <div
            className={clsx(
              ...
              // Focus
              'outline-none data-[focus]:bg-lime-500 data-[focus]:text-white',
